<tr x-data="{ show: true }" x-show="show">
    <th class="pl-0 border-0" scope="row">
        <div class="media align-items-center">
            <a class="reset-anchor d-block animsition-link"
                href="{{ route('frontend.product', $cartItem->model->slug) }}">
    ...
    <td class="align-middle border-0">
        <div class="border d-flex align-items-center justify-content-between px-3">
            ...
            <div class="quantity">
                <button wire:click.prevent="decreaseQuantity('{{ $cartItem->rowId }}')" class="p-0"><i
                ...
                <button wire:click.prevent="increaseQuantity('{{ $cartItem->rowId }}')" class="p-0"><i
