                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control typeahead" name="customer_name" id="customer_name" value="{{ old('customer_name', request()->input('customer_name')) }}" placeholder="typing something to search customer..." autocomplete="off">
