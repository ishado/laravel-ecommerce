                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="product text-center">
                            ...
                            <h6> <a class="reset-anchor" href="{{ route('frontend.detail') }}">Cyan cotton t-shirt</a>
                            </h6>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="product text-center">
                            ...
                            <h6> <a class="reset-anchor" href="{{ route('frontend.detail') }}">Timex Unisex
                                    Originals</a></h6>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="product text-center">
                            ...
                            <h6> <a class="reset-anchor" href="{{ route('frontend.detail') }}">Red digital
                                    smartwatch</a></h6>
                            <p class="small text-muted">$250</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="product text-center">
                            ...
                            <h6> <a class="reset-anchor" href="{{ route('frontend.detail') }}">Joemalone Women
                                    prefume</a></h6>
                            <p class="small text-muted">$25</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="product text-center">
                            ...
                            <h6> <a class="reset-anchor" href="{{ route('frontend.detail') }}">Men silver Byron
                                    Watch</a></h6>
                            <p class="small text-muted">$351</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="product text-center">
                            ...
                            <h6> <a class="reset-anchor" href="{{ route('frontend.detail') }}">Ploaroid one step
                                    camera</a></h6>
                            <p class="small text-muted">$351</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="product text-center">
                            ...
                            <h6> <a class="reset-anchor" href="{{ route('frontend.detail') }}">Gray Nike running
                                    shoes</a></h6>
                            <p class="small text-muted">$351</p>
                        </div>
                    </div>
