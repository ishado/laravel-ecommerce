        ...
        <div class="row mb-5">
            ...
            <div class="col-lg-6">
                <ul class="list-inline mb-2">
                    ...
                    @for ($i = 0; $i < 5; $i++) <li class="list-inline-item m-0"><i
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="media mb-3">
                                <img class="rounded-circle" src="{{ asset('frontend/img/customer-1.png') }}" alt=""
                                    width="50">
                                <div class="media-body ml-3">
                                    ...
                                    <ul class="list-inline mb-1 text-xs">
                                        @if ($review->rating != '')
                                        @for ($i = 0; $i < 5; $i++) <li class="list-inline-item m-0">
                                            <i
